...
export interface BentoCardProps {
    ...
    img?: string; // New: Image URL
    imgClassName?: string; // New: Image Custom Class
    span?: string; // New: Grid span class
}
                                    ...
                                    <>
                                        <div className="absolute inset-0 z-0">
                                            <Image
                                                ...
                                                fill
                                                className={`object-cover transition-transform duration-700 hover:scale-110 ${card.imgClassName || ''}`}
                                            />
                                        </div>
